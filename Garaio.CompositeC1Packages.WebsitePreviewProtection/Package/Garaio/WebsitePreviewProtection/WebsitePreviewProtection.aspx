<%@ Page Language="C#" AutoEventWireup="true" CodeFile="WebsitePreviewProtection.aspx.cs" Inherits="Garaio.CompositeC1Packages.WebsitePreviewProtection.Package.Garaio.WebsitePreviewProtection.WebsitePreviewProtection" %>
<%@ Import Namespace="Garaio.CompositeC1Packages.WebsitePreviewProtection.Package.App_GlobalResources" %>

<html xmlns="http://www.w3.org/1999/xhtml">
	<head runat="server">
		<title><%= Resources_Text.Page_Title%></title>
		...
		<script type="text/javascript">
			...
			function submitForm() {
				document.getElementById('<%= frmLogin.ClientID %>').submit();
			}
		</script>
			...
			<div id="splashcontent">
				<form runat="server" id="frmLogin" method="post">
					...
					<div class="fields">
						<div class="field">
							<div class="label">
								<label for="txtUsername"><%= Resources_Text.Label_Username_Text%></label>
							</div>
							<div class="value">
						...
						<div class="field">
							<div class="label">
								<label for="txtPassword"><%= Resources_Text.Label_Password_Text%></label>
							</div>
							<div class="value">
						...
						<div class="LoginButton">
							<a runat="server" href="#" id="btnLogin" tabindex="3">
								<%= Resources_Text.Button_Login_Text%>
							</a>
						</div>
					</div>
				</form>
